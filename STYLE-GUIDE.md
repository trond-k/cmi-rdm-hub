...
## Glossary and linking conventions
...
- A term, abbreviation, or acronym is used in the guide and is not common knowledge outside the field (e.g., FAIR, DMP, DOI, ORCID, pseudonymisation, CoreTrustSeal).
...
- **Definition** in one to three sentences.
- **Link** to the official homepage or specification, where one exists.
- **Related terms** or cross-references within the glossary, where useful.
