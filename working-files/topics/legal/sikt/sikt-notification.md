---
icon: lucide/send
title: Prepare a Sikt notification
description: What the Sikt notification is, what to have ready, and what CMI's standard answers are.
tags:
  - Sikt
  - GDPR
  - Personal data
...
If you are still unsure whether the project involves personal data at all, start with the [Personal data guide](personal-data-guide.md) or the [Personal Data Decider](../templates-and-tools/personal-data-decider.md) first.

[Open the Sikt portal :lucide-arrow-right:](https://minforskning.sikt.no){ .md-button }

## What the notification is (and isn't)

The Sikt notification is not a research ethics approval and it is not a barrier to getting started. It is the formal description of how your project will process personal data, what safeguards you will use, and what will happen to the data at the end. Sikt's role is to [assess whether what you describe is consistent](https://sikt.no/en/study-or-research/notification-form-personal-data/assessment/types) with data protection requirements.
...
- a clear view of which personal data categories you will process (the [Data Classifier](../templates-and-tools/data-classifier.md) can help)
- a draft [participant information letter](https://sikt.no/en/study-or-research/notification-form-personal-data/information-for-participants) or equivalent participant-facing information
- your [project data workflow](project-data-workflow.md), including storage and access arrangements
...
For the section-by-section walkthrough you can use with the form open, see the [Sikt form walkthrough](../templates-and-tools/sikt-form-walkthrough.md).
...
If the project changes later, [amend the existing notification](https://sikt.no/en/node/126) rather than starting over. Typical triggers are:
